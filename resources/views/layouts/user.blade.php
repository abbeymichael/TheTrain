...
<head>
    ...
    <title>{{ $title ?? 'My Account' }} — TheTrain</title>
            ...
            <div class="hidden md:flex items-center gap-1">
                <a href="{{ route('user.dashboard') }}"
                   class="flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                          {{ request()->routeIs('user.dashboard') ? 'bg-[#c6ebd5] text-[#2e4a3d]' : 'text-[#414844] hover:text-[#416352] hover:bg-[#f0faf5]' }}">
                ...
                <a href="{{ route('user.trips') }}"
                   class="flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                          {{ request()->routeIs('user.trips', 'user.trip.details') ? 'bg-[#c6ebd5] text-[#2e4a3d]' : 'text-[#414844] hover:text-[#416352] hover:bg-[#f0faf5]' }}">
                    <span class="material-symbols-outlined text-[18px]" style="font-variation-settings:'FILL' 0,'wght' 400,'GRAD' 0,'opsz' 24;">train</span>
                    My Trips
                </a>
                <a href="{{ route('user.profile') }}"
                   class="flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                          {{ request()->routeIs('user.profile') ? 'bg-[#c6ebd5] text-[#2e4a3d]' : 'text-[#414844] hover:text-[#416352] hover:bg-[#f0faf5]' }}">
                    <span class="material-symbols-outlined text-[18px]" style="font-variation-settings:'FILL' 0,'wght' 400,'GRAD' 0,'opsz' 24;">person</span>
                    Profile
                </a>
                <a href="{{ route('trips') }}"
                   class="flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium text-[#414844] hover:text-[#416352] hover:bg-[#f0faf5] transition-colors">
